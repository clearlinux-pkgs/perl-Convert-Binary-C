...
Source0  : https://cpan.metacpan.org/authors/id/M/MH/MHX/Convert-Binary-C-0.79.tar.gz
...
%prep
%setup -q -n Convert-Binary-C-0.79
cd %{_builddir}
tar xf %{_sourcedir}/libconvert-binary-c-perl_0.78-1.debian.tar.xz
cd %{_builddir}/Convert-Binary-C-0.79
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Convert-Binary-C-0.79/deblicense/
