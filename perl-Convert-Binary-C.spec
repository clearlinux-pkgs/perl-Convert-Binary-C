...
Source0  : https://cpan.metacpan.org/authors/id/M/MH/MHX/Convert-Binary-C-0.82.tar.gz
...
%prep
%setup -q -n Convert-Binary-C-0.82
cd %{_builddir}
tar xf %{_sourcedir}/libconvert-binary-c-perl_0.78-1.debian.tar.xz
cd %{_builddir}/Convert-Binary-C-0.82
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Convert-Binary-C-0.82/deblicense/
...
cp %{_builddir}/Convert-Binary-C-0.82/tests/include/pdclib/COPYING.CC0 %{buildroot}/usr/share/package-licenses/perl-Convert-Binary-C/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
