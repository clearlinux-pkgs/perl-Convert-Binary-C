...
Version  : 0.83
Release  : 18
URL      : https://cpan.metacpan.org/authors/id/M/MH/MHX/Convert-Binary-C-0.83.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/M/MH/MHX/Convert-Binary-C-0.83.tar.gz
...
%prep
%setup -q -n Convert-Binary-C-0.83
cd %{_builddir}
tar xf %{_sourcedir}/libconvert-binary-c-perl_0.78-1.debian.tar.xz
cd %{_builddir}/Convert-Binary-C-0.83
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Convert-Binary-C-0.83/deblicense/
...
cp %{_builddir}/Convert-Binary-C-0.83/tests/include/pdclib/COPYING.CC0 %{buildroot}/usr/share/package-licenses/perl-Convert-Binary-C/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/x86_64-linux-thread-multi/Convert/Binary/C.pm
/usr/lib/perl5/vendor_perl/5.30.3/x86_64-linux-thread-multi/Convert/Binary/C/Cached.pm
/usr/lib/perl5/vendor_perl/5.30.3/x86_64-linux-thread-multi/auto/Convert/Binary/C/C.so
